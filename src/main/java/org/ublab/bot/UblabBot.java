...
public abstract class UblabBot implements ReplyConstants {
     ...
     *
     * @return The name of the ublab-bot.
     */
     ...
     *
     * @return The login of the ublab-bot.
     */
     ...
     *
     * @return The version of the ublab-bot.
     */
     ...
     *
     * @return The finger message of the ublab-bot.
     */
     ...
     *
     * @return True if and only if the ublab-bot is currently connected to a server.
     */
     ...
     * A value of null is returned if the ublab-bot has never tried to connect
     * to a server.
     * 
     ...
     * This does not imply that the connection attempt to the server was
     * successful (we suggest you look at the onConnect method).
     * A value of -1 is returned if the ublab-bot has never tried to connect
     * to a server.
     * 
     * @since ublab-bot 0.9.9
     * 
     ...
     * 
     * @param charset The new encoding charset to be used by ublab-bot.
     * 
     ...
     * @since ublab-bot 1.4.4
     * 
     * @return An array of port numbers that ublab-bot can use to send DCC
     ...
     * @since ublab-bot 1.4.4
     * 
     * @param ports The set of port numbers that ublab-bot may use for DCC
     ...
     * ublab-bots in such collections.
     * 
     * @since ublab-bot 0.9.9
     * 
     * @return the hash code for this instance of ublab-bot.
     */
    public int hashCode() {
     ...
     * if you are using more than one ublab-bot instance to achieve
     * multiple server connectivity. The format of
     * this String may change between different versions of ublab-bot
     * but is currently something of the form
     * <code>
     *   Version{ublab-bot x.y.z Java IRC Bot - www.jibble.org}
     *   Connected{true}
     *   Server{irc.dal.net}
     *   Port{6667}
     *   Password{}
